...
<div class="mesa-eletronica">
	...
	<div class="container-fluid">
					...
					<a href="?lda_consulta&fltsituacao='A','T'" class="waves-effect">
						<div class="media">
							...
							<div class="media-body">
								...
								<div class="number" title="Solicitações abertas e em tramitação"><span class="count"><?= $solAbertas; ?></span></div>					
							</div>				
						</div>	
					</a>		
				</div>
				...
				<div class="card icon positive">
					<a href="?lda_consulta&fltsituacao='T'" class="waves-effect">
						<div class="media">
							...
							<div class="media-body">
								Em tramitação
								<div class="number" title="Solicitações em tramitação"><span class="count"><?= $solTramita; ?></span></div>
							</div>
						</div>
					</a>
				</div>
					...
					<a href="?lda_consulta&fltsituacao='R'" class="waves-effect">
						<div class="media">
							...
							<div class="media-body">
								...
								<div class="number" title="Solicitações respondidas"><span class="count"><?= $solResp; ?></span></div>
							</div>
						</div>
					</a>
				</div>
				...
				<div class="card icon assertive">
					<a href="?lda_consulta&fltsituacao='N'" class="waves-effect">
						<div class="media">
							...
							<div class="media-body">
								Negado
								<div class="number" title="Solicitações negadas"><span class="count"><?= $solNegado;  ?></span></div>
							</div>
						</div>
					</a>
				</div>
		...
		<div class="row m-b">
			<div class="col-md-12">
				<h4 class="subtitle">Índice de satisfação</h4>
			</div>
			<div class="col-md-4 col-xs-12">
				<div class="boll-table">
					<table class="table">
		...
		<!--div class="row m-b">
			<div class="col-md-12">
				<h4 class="subtitle">Demandas por mês</h4>
				<div class="boll-table">
					<table class="table">
						<thead>
							<tr>
