	...
	<tr id="ldadosCidadao">
		<td colspan="2">
			...
			<tr>
				...
				<td align="left">
					<input type="text" name="cpfcnpj" value="<?php echo $cpfcnpj;?>" onkeyup="soNumero(this);" onblur="document.getElementById('span_usuario').innerHTML = this.value;" size="14" maxlength="14" readonly/> 
				</td>  
			</tr>
			<tr id="lnFaixaEtaria">
		...
		<td colspan="2">
			...
			<table width="100%">
				<tr>
					...
					<td align="left">
						<input type="text" name="cep" id="cep" value="<?php echo $cep;?>" autocomplete="off" onkeyup="busca(this.value,this.value.length==8,'<?php echo SITELNK;?>inc/buscacep')" onclick="busca(this.value,this.value.length==8,'<?php echo SITELNK;?>inc/buscacep')" maxlength="8" size="10" />		
						<a href="http://www.buscacep.correios.com.br/servicos/dnec/menuAction.do?Metodo=menuEndereco" target="_blank"><img src="<?php echo SITELNK;?>img/busca_cep_correios.gif" border="0" align="absmiddle" style="margin:0px;padding:0px" title="Pesquisa CEP no site dos correios"></a>
					</td>
				</tr>
				<tr>
